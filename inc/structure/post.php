...
if ( ! function_exists( 'et_shop_paging_nav' ) ) {
   ...
   */
  function et_shop_paging_nav() {
    global $wp_query;

    $args = array(
      'type'       => 'list',
      'next_text' => _x( 'Next', 'Next post', 'et_shop' ) . '&nbsp;<span class="meta-nav">&rarr;</span>',
      'prev_text' => '<span class="meta-nav">&larr;</span>&nbsp' . _x( 'Previous', 'Previous post', 'et_shop' ),
      );
...
if ( ! function_exists( 'et_shop_posted_on' ) ) {
  ...
  function et_shop_posted_on() {
    ...
    $posted_on = sprintf(
      _x( 'Posted on %s', 'post date', 'et_shop' ),
      '<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
    );

    $byline = sprintf(
      _x( 'by %s', 'post author', 'et_shop' ),
    ...
    echo apply_filters( 'et_shop_single_post_posted_on_html', '<span class="posted-on">' . $posted_on . '</span><span class="byline"> ' . $byline . '</span>', $posted_on, $byline );
